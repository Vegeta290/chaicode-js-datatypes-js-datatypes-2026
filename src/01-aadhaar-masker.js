...
export function maskAadhaar(aadhaarNumber) {
  ...
  const firstSlice = aadhaarNumber.slice(0,4);
  const secondSlice = aadhaarNumber.slice(4,8);
  const thirdSlice = aadhaarNumber.slice(8,12);
  let masked = "XXXX-XXXX-"+thirdSlice;
  return masked;
